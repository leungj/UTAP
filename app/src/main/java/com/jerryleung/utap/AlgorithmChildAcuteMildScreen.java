 ...
 */
public class AlgorithmChildAcuteMildScreen extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.algorithm_child_acute_mild_screen_layout);

        myTextView = (TextView)findViewById(R.id.child_acute_mild_content);
